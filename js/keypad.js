...
GameBoyAdvanceKeypad.prototype.registerHandlers = function() {
  ...
  {
    var e = joypad[i];
    e.ontouchstart = this.joypadHander.bind(this);
    e.ontouchend = this.joypadHander.bind(this);
    e.onmouseup = this.joypadHander.bind(this);
    e.onmousedown = this.joypadHander.bind(this);
  }
};
